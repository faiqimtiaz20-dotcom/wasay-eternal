...
export async function handleSendOrderEmail(
  order: unknown
  ...
  <div class="wrapper">
    ...
    <div class="content">
      <p style="font-size: 14px; color: #d4d4d8; line-height: 1.6; font-weight: 300; margin-top: 0; margin-bottom: 25px;">
        Dear ${payload.customerName || "Customer"}, thank you for your sartorial trust. We have successfully registered your custom order details. Below is your transaction overview:
      </p>
      ...
      <div class="totals-section">
        ...
        <div class="total-row grand-total">
          ...
          <span style="color: #ffffff;">${payload.totalPrice}</span>
        </div>
      </div>
      
      <p style="font-size: 12px; color: #f59e0b; margin-top: 30px; margin-bottom: 0; line-height: 1.5; font-weight: 500;">
        COMPLIMENTARY COURIER PROTECTION AND 10-YEAR LIFETIME REPAIR WARRANTY ACTIVED IMMEDIATELY.
      </p>
    </div>
    <div class="footer">
...
<body>
  <div class="container">
    ...
    <div class="field">
      ...
      <div class="val" style="color:#f59e0b">${payload.orderId}</div>
    </div>
    <div class="field">
    ...
    <div class="field">
      ...
      <div class="val" style="color: #22d3ee">${payload.customerPhone}</div>
    </div>
    <div class="field">
      <div class="label">Email Address</div>
      <div class="val">${payload.customerEmail}</div>
    </div>
    <div class="field">
      <div class="label">Shipping Address</div>
      <div class="val">${payload.customerAddress}</div>
    </div>
    <div class="field">
      <div class="label">Customer Notes</div>
      <div class="val" style="font-style: italic; color:#d4d4d8">${payload.notes || "None"}</div>
    </div>
    ...
    <div style="margin-top: 20px; text-align: right; font-size: 16px;">
      ...
      <strong style="color: #f59e0b; padding-left: 10px;">${payload.totalPrice}</strong>
    </div>
  </div>
</body>
</html>
`;
    ...
    if (secureSmtpConfigured) {
      ...
      console.log(
        `[Email System] Successfully sent order emails [Order ID: ${payload.orderId}] to ${clientEmail} and ${adminEmail} via SMTP.`
      );
    } else {
      console.log("--------------------------------------------------");
      ...
      console.log(`STATUS: SMTP Credentials not configured in environment.`);
      console.log("--------------------------------------------------");
    }
